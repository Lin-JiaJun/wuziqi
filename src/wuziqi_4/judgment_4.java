...
public class judgment_4 {
	private ArrayList<shape_4> black;
	private ArrayList<shape_4> white;
	
	public judgment_4(ArrayList<shape_4> black, ArrayList<shape_4> white) {
		this.black = black;
		this.white = white;
	}
	public judgment_4(ArrayList<shape_4> black, ArrayList<shape_4> white,int x1,int y1) {
		this.black = black;
		this.white = white;
		judgeblack(x1,  y1);
	}
