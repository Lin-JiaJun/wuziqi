...
public class AI_3 {
	...
	public AI_3(ArrayList<shape_3> black, ArrayList<shape_3> white) {
		this.black = black;
		this.white = white;
	}
	...
	public int setinteger(int x, int y) {
		// 212表示下完后棋局的情况，为212. p.s. 1 means black
		hm.put("010", 1);
		hm.put("0110", 30);
		hm.put("01110", 60);
		hm.put("011110", 200000);
		hm.put("012", 10);
		hm.put("0111112",1000011111);
		hm.put("0112", 20);
		hm.put("01112", 30);
		hm.put("011112", 2000000);
		hm.put("011112", 1000000000);
		hm.put("212", 5);
		hm.put("2112", 5);
		hm.put("21112", 5);
		hm.put("211112", 5);
